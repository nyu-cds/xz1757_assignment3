...
def nbody(loops, reference, iterations):
    ...
    # define the initial value of BODIES variable
    ...
    for _ in range(loops):
        report_energy(BODIES, e=0.0)
        for _ in range(iterations):
            advance(0.01, BODIES)
        print(report_energy(BODIES, e=0.0))
