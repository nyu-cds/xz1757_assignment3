...
"""
'''
Version_iter execution time: 0m28.4s
Comparing with original version, Relative Speedup (R): 3.79
'''
import itertools
from itertools import combinations

def find_pairs(BODIES):
    #add itertools solution here
    key_pairs = set(combinations(BODIES,2))
